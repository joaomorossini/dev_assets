...
alias dify_azure_vm="ssh -i /Users/morossini/Projects/dify_azure_deployment/dify-vm-ssh-key.pem morossini@135.233.98.87"
...
# . "/Users/morossini/anaconda3/etc/profile.d/conda.sh"  # commented out by conda initialize
    else
# export PATH="/Users/morossini/anaconda3/bin:$PATH"  # commented out by conda initialize
    fi
fi
unset __conda_setup
...
alias clear_pycache="find . -name \"__pycache__\" -exec rm -rf {} +"
